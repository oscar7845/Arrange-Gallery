...
if __name__ == "__main__":
    ...
    image_file_formats=[".jpg",".png",".jpeg",".gif"]
    aspect_ratio_range = (0,2)
    camera_orientation_range = range(1,8)
    ...
    generate_slideshow(color_dominance,color_diversity,color_warmth ,color_intensity,
                       min_image_quality,min_image_resolution,max_image_resolution,image_file_formats,
                       aspect_ratio_range ,camera_orientation_range ,text_occurrences,image_smooth_edges,
                       image_feeling ,environment ,sift_features ,people,allowed_objects,not_allowed_objects)